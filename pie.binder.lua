...
function main()
    ...
    if pie.__VERSION ~= thisScript().version_num then
        sampAddChatMessage('{AB000C}the imgui_piemenu version does not match the pie binder')
        sampAddChatMessage('{AB000C}.. it will cause problems!')
    end
...
%s]]):format( thisScript().version_num,upd.version,upd.log ) ))
                    if imgui.Button('update!',imgui.ImVec2(-1,50)) then
                        ...
                        lua_thread.create(function()
                            ...
                            local d = false
                            downloadUrlToFile('https://raw.githubusercontent.com/v3sp4n/pie-binder/main/lib/imgui_piemenu(for%20pie%20binder).lua',getWorkingDirectory()..'/lib/imgui_piemenu(for pie binder).lua',function(_,s)
                                if s == 58 then
                                    d = true
                                end
                            end)
                            while not d do wait(0) end
                            downloadUrlToFile('https://raw.githubusercontent.com/v3sp4n/pie-binder/main/pie%20binder.lua',thisScript().path,function(_,s)
                                if s == 58 then
                                    window.v = false
                                    pie.window.v = false
                                    sampAddChatMessage('successful download update, reloading script..')
                                    thisScript():reload()
                                end
                            end)
...
function getCarColorName(handle)
    local names = {
        ...
        {{4},"Красный"},
        {{5},"Зеленый"},
        {{6},"Умеренный красно-пурпурный"},
        {{7},"Желтый"},
        {{8, 136},"Блестящий синий"},
        {{9, 139},"Светло-серый"},
        {{10, 48, 251},"Кварцевый серый"},
        {{11},"Умеренный синий"},
        {{12},"Перламутрово-ежевичный"},
        {{13, 60, 101},"Отдаленно-синий"},
        {{14},"Цвет мокрого асфальта"},
        {{15},"Светлый серый"},
        {{16},"Серый нейтральный"},
        {{17, 92},"Серая спаржа"},
        {{18, 43, 59, 83, 125, 182, 213},"Пурпурно-красный"},
        {{19, 71, 116, 118, 122},"Перламутрово-рубиновый"},
        {{20, 70, 77, 90},"Перламутровый светло-серый"},
        {{21, 29, 205},"Фиолетово-синий"},
        {{22},"Каштаново-коричневый"},
        {{23, 89, 243},"Винно-красный"},
        {{24, 51, 97, 121},"Серый Крайола"},
        {{25},"Брезентово-серый"},
        {{26, 255},"Темный синевато-черный"},
        {{27, 91},"Агатовый серый"},
        {{28, 123},"Бежево-серый"},
        {{30, 39, 61, 197},"Сигнальный серый"},
        {{31},"Черно-красный"},
        {{32},"Желто-оливковый"},
        {{33},"Цвет Хабрахабра"},
        {{34, 254},"Пыльно-серый"},
        {{35},"Базальтово-серый"},
        {{36},"Темный зеленовато-серый"},
        {{37, 206},"Синевато-черный"},
        {{38},"Темный зеленовато-желто-зеленый"},
        {{40, 68, 72, 98},"Светло-серый шифер"},
        {{42},"Пурпурно-серый"},
        {{44},"Розовый лес"},
        {{45},"Темный серо-оливково-зеленый"},
        {{46, 133, 225},"Красно-коричневый"},
        {{47},"Серо-бежевый"},
        {{49},"Перламутровый темно-серый"},
        {{50},"Серебряный"},
        {{52},"Сосновый зеленый"},
        {{53, 110},"Серовато-синий"},
        {{54},"Зелено-синий"},
        {{55, 96, 117, 204, 256},"Океанская синь"},
        {{56},"Красновато-серый"},
        {{57},"Серое окно"},
        {{58, 105},"Желто-серый"},
        {{62},"Светлый серо-оливковый"},
        {{63},"Темный красный"},
        {{64, 74, 112},"Серебристо-серый"},
        {{65},"Бело-алюминиевый"},
        {{66, 196},"Умеренный желто-зеленый"},
        {{67},"Темный серо-красно-коричневый"},
        {{69},"Галечный серый"},
        {{73},"Темно-серый"},
        {{75, 231},"Глубокий коричневый"},
        {{76},"Серый синий"},
        {{78},"Светлый зеленовато-белый"},
        {{79},"Коричнево-красный"},
        {{80},"Транспортный синий"},
        {{81},"Глубокий красно-пурпурный"},
        {{82},"Серовато-желто-зеленый"},
        {{84},"Миртовый"},
        {{85},"Оливковый серый"},
        {{86},"Красно-фиолетовый"},
        {{87},"Папоротниково-зеленый"},
        {{88, 247},"Водная синь"},
        {{93, 186},"Серый"},
        {{94},"Насыщенный зеленовато-синий"},
        {{95},"Темно-бирюзовый"},
        {{99},"Голубино-синий"},
        {{100},"Бледный серо-коричневый"},
        {{102},"Перламутровый опаловый"},
        {{103},"Бобровый"},
        {{104, 210},"Темно-лазурный"},
        {{106},"Тусклый серый"},
        {{107},"Цвет Черного моря"},
        {{108},"Перламутровый мышино-серый"},
        {{109, 209},"Цвет Фейсбука"},
        {{111, 219},"Светлый оливковый серый"},
        {{113},"Мятно-бирюзовый"},
        {{114},"Шоколадно-коричневый"},
        {{115},"Фельдграу"},
        {{119},"Ниагара"},
        {{120},"Серовато-пурпурный"},
        {{124},"Темно-коричневый"},
        {{126},"Сапфировый"},
        {{127},"Маджента Крайола"},
        {{128, 134},"Зеленовато-черный"},
        {{129, 230},"Индийский зеленый"},
        {{130},"Черновато-красный"},
        {{131},"Лазурно-синий"},
        {{132},"Темный желтовато-коричневый"},
        {{135},"Сигнальный синий"},
        {{137},"Пурпурное сердце"},
        {{138},"Майский зеленый"},
        {{140},"Темный аспидно-синий"},
        {{141, 194},"Темный телегрей"},
        {{142},"Синевато-серый"},
        {{143},"Насыщенный желто-зеленый"},
        {{144, 145},"Сине-сиреневый"},
        {{146},"Блестящий желтовато-зеленый"},
        {{147, 179, 238},"Умеренный пурпурный"},
        {{148, 185},"Красно-сиреневый"},
        {{149},"Коричневато-черный"},
        {{150},"Красновато-черный"},
        {{151},"Оливково-черный"},
        {{152},"Зеленый мох"},
        {{153, 163},"Фиолетово-синий Крайола"},
        {{154},"Патиново-зеленый"},
        {{155},"Зеленое море"},
        {{156},"Зеленые джунгли Крайола 90-го года"},
        {{157},"Бледно-зеленый"},
        {{158},"Бледный синий"},
        {{159, 223},"Темный красно-оранжевый"},
        {{160},"Темный оливково-коричневый"},
        {{161},"Графитно-черный"},
        {{162},"Серовато-пурпурно-красный"},
        {{164},"Зеленая сосна Крайола"},
        {{165},"Черно-серый"},
        {{166},"Насыщенный синевато-зеленый"},
        {{167, 199},"Капри синий"},
        {{168},"Серобуромалиновый"},
        {{169},"Цвет блошиного брюшка"},
        {{170},"Светлый пурпурно-синий"},
        {{171},"Перламутрово-фиолетовый"},
        {{172},"Насыщенный фиолетовый"},
        {{173},"Черновато-зеленый"},
        {{174},"Темный Коричневый"},
        {{175},"Махагон коричневый"},
        {{176},"Томатно-красный"},
        {{177},"Сливовый Крайола"},
        {{178},"Сигнальный фиолетовый"},
        {{180, 250},"Пурпурно-фиолетовый"},
        {{181},"Умеренный коричневый"},
        {{183, 184},"Умбра жженая"},
        {{187, 216},"Черный янтарь"},
        {{188, 235},"Очень глубокий желто-зеленый"},
        {{189, 190, 207, 237},"Очень темный зеленый"},
        {{191},"Темная Византия"},
        {{192},"Арлекин"},
        {{193},"Розовый кварц"},
        {{195, 229},"Темный зеленовато-желтый"},
        {{198},"Зелено-коричневый"},
        {{200},"Очень темный хаки"},
        {{201},"Средний серый"},
        {{202},"Горечавково-синий"},
        {{203},"Фталоцианиновый зеленый"},
        {{208},"Сине-зеленый"},
        {{211},"Перламутровый ночной"},
        {{212},"Пурпурно-синий"},
        {{214},"Телегрей"},
        {{215},"Умеренно-оливковый"},
        {{217},"Терракотовый"},
        {{218},"Светлый зеленовато-синий"},
        {{220},"Охра коричневая"},
        {{221},"Насыщенный красно-пурпурный"},
        {{222},"Охра желтая"},
        {{224},"Темно-синий"},
        {{226},"Темный желтовато-зеленый"},
        {{227, 242},"Травяной"},
        {{228},"Темно-зеленый"},
        {{232},"Натуральная умбра"},
        {{233},"Яркий пурпурный"},
        {{234},"Византия"},
        {{236},"Очень темный оливковый"},
        {{239},"Коричнево-бежевый"},
        {{240},"Насыщенный коричневый"},
        {{241},"Блестящий зеленовато-синий"},
        {{244},"Изумрудно-зеленый"},
        {{245},"Темный красно-коричневый"},
        {{246},"Очень темный желто-зеленый"},
        {{248},"Антрацитовый"},
        {{249},"Кофейный"},
        {{252},"Черно-зеленый"},
        {{253},"Бистр"},
